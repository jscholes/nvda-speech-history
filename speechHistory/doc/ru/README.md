...
* Нажмите NVDA+H чтобы открыть диалог, в котором собраны все сообщения истории речи.
* Функция звукового сигнала при появлении нового текста была удалена.

## Внесение вклада
Пожалуйста, ознакомьтесь с [рекомендациями по внесению вклада](https://github.com/jscholes/nvda-speech-history/blob/master/CONTRIBUTING.md).